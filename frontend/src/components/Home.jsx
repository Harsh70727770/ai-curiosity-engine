...
export default function Home({ navigateTo }) {
    return (
        <div className="flex flex-col md:flex-row w-full h-screen overflow-hidden bg-slate-950">
            ...
            <div className="relative w-full md:basis-1/2 h-[50vh] md:h-full flex flex-col justify-center items-center p-6 md:p-12 lg:p-16 bg-gradient-to-br from-slate-900 via-[#0f172a] to-slate-950 overflow-y-auto">
                ...
                <div className="relative z-10 flex flex-col items-center text-center max-w-lg mx-auto w-full">
                    ...
                    {/* Badge */}
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-800/80 border border-slate-700 text-cyan-400 text-sm font-semibold mb-6 shadow-lg backdrop-blur-md">
                    ...
                    {/* Title */}
                    <h1 className="text-3xl md:text-4xl lg:text-6xl font-extrabold text-white mb-6 tracking-tight leading-tight">
                        AI <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">Curiosity Engine</span>
                    </h1>
                    
                    {/* Description */}
                    <p className="text-base md:text-lg text-slate-300 mb-8 leading-relaxed font-medium">
