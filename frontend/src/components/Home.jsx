import bg from "../images/curosity_engine.png";

export default function Home({ navigateTo }) {
    return (
        <div 
            className="relative w-full h-screen overflow-hidden flex flex-col items-center justify-center pt-20"
            style={{ 
        ...
        >
            ...
            {/* Content */}
            <div className="relative z-10 flex flex-col items-center text-center p-6 md:p-12 w-full max-w-3xl mx-auto">
